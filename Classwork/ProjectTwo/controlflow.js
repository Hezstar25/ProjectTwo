...
const beauty = prompt('Enter your grade')
switch (beauty) {
    case 'A':
        console.log('eggcellent')
    case 'B':
        console.log('U sha try')
        break;
    case 'C':
        console.log('u sef don try bt e no ')
        break;
    case 'D':
        console.log('u no even try')
        break;
    case 'F':
        console.log('Return ur school fees')
